...
import { SunIcon, MoonIcon, HistoryIcon, HomeIcon, FullscreenEnterIcon, FullscreenExitIcon, AboutIcon } from './components/icons/Icons';
    ...
    <div className="min-h-screen w-full transition-colors duration-300">
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between p-4 bg-light-primary/80 dark:bg-dark-primary/80 backdrop-blur-sm">
        ...
        <nav className="flex items-center gap-4">
            {screen > Screen.Splash && <button onClick={resetToHome} className="p-2 rounded-full hover:bg-black/10 dark:hover:bg-white/10 transition-colors" title="Home"><HomeIcon /></button>}
            <button onClick={handleViewHistory} className="p-2 rounded-full hover:bg-black/10 dark:hover:bg-white/10 transition-colors" title="History"><HistoryIcon /></button>
            <button onClick={handleViewAbout} className="p-2 rounded-full hover:bg-black/10 dark:hover:bg-white/10 transition-colors" title="About"><AboutIcon /></button>
            <button onClick={toggleTheme} className="p-2 rounded-full hover:bg-black/10 dark:hover:bg-white/10 transition-colors" title="Toggle Theme">
                {isDarkMode ? <SunIcon /> : <MoonIcon />}
            </button>
            <button onClick={toggleFullScreen} className="p-2 rounded-full hover:bg-black/10 dark:hover:bg-white/10 transition-colors" title="Toggle Fullscreen">
