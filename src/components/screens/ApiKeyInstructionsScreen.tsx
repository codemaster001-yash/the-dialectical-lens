  ...
  return (
    <div className="fixed inset-0 z-[100] bg-light-primary dark:bg-dark-primary flex items-center justify-center p-4">
      <div className="max-w-4xl w-full bg-light-secondary dark:bg-dark-secondary p-8 rounded-2xl shadow-2xl border-2 border-red-500 animate-fade-in">
        <h1 className="text-3xl font-bold text-red-600 dark:text-red-500 text-center">
          Configuration Required
        </h1>
        <p className="mt-4 text-center text-lg text-light-text/80 dark:text-dark-text/80">
          A Google Gemini API key is required. The application is now using a
          secure, standard build process.
        </p>
          ...
          <div className="bg-light-primary dark:bg-dark-primary p-6 rounded-lg">
            ...
            <ol className="list-decimal list-inside space-y-2">
              <li>
                ...
                <code className="bg-gray-300 dark:bg-gray-600 px-1 py-0.5 rounded-sm">
                  .env
                </code>{" "}
                in the root of your project.
              </li>
              <li>
                Add the following line to the file, replacing the placeholder
                with your key.
              </li>
            ...
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>
                ...
                <span className="font-semibold">
                  Site configuration &rarr; Build & deploy &rarr; Environment
                </span>
                .
              </li>
              ...
              <li className="list-none ml-4 mt-2">
                ...
                <br />- Value:{" "}
                <span className="italic">(Your actual API key)</span>
              </li>
